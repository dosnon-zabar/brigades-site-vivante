...
export const evenements: Evenement[] = [
  {
    ...
    notes: null,
    team_id: null,
    photo_url: "https://chefmate-admin.zabar.fr/cdn/evenements/banquet-village.jpg",
    images: [],
    temoignages: [],
  ...
  },
  {
    ...
    notes: null,
    team_id: null,
    photo_url: "https://chefmate-admin.zabar.fr/cdn/evenements/atelier-cuisine.jpg",
    images: [],
    temoignages: [],
  ...
  },
  {
    ...
    notes: null,
    team_id: null,
    photo_url: "https://chefmate-admin.zabar.fr/cdn/evenements/marche-paysan.jpg",
    images: [],
    temoignages: [],
